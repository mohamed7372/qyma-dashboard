...
const ArticleAdmin = () => {
    ...
    useEffect(() => {
        articlesService
            .getAll(100, searchSlice,dateFromSlice,dateToSlice,'',topicSlice, statusSlice)
            .then((res) => {
            ...
            <main className='col-span-10 px-8'>
                ...
                <Card>
                    <div className='flex items-center mt-2'>
                        <h1 className='text-xl font-bold capitalize mr-4'>All Articles</h1>
                    ...
                    <Filter/>
                    <ArticleTable setAlert={setAlert} setMsgAlert={setMsgAlert}/>
