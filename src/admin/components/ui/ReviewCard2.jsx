...
const ReviewCard2 = ({review}) => {
    ...
    return (
        <div className="flex shadow-sm hover:shadow-lg p-4 rounded-lg mb-3 bg-white">
            ...
            <div className="details w-full">
                <div className="head flex md:items-center justify-between mb-2 flex-col md:flex-row">
                    <div className="flex md:items-center flex-col md:flex-row">
                        ...
                        <p className="font-light text-xs text-gray-500">@{review.user.username }</p>
                    </div>
                    <p className="font-light text-xs text-gray-500">{dateFormat}</p>
                </div>
                ...
                <div className="mb-4 flex">
                    <div className={`hover:bg-primary-50 cursor-pointer flex items-center border rounded-md w-fit px-4 py-1 ${like && 'bg-primary-150'}`} onClick={addLike}>
                        ...
                        <span className="text-gray-500 text-xs font-bold ml-2">Helpful ({nbrLike})</span>
                    </div>
                    <div className={`hover:bg-primary-50 ml-4 cursor-pointer flex items-center border rounded-md w-fit px-4 py-1 ${dislike && 'bg-primary-150'}`} onClick={addDisLike}>
                        ...
                        <span className="text-gray-500 text-xs font-bold ml-2">Dislike ({nbrLDslike})</span>
                    </div>
                </div>
            </div>
        </div>
